  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <button className="hidden md:block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-full font-medium transition-all">
          Try Sample Check
        </button>
      </nav>
      ...
      <footer className="container mx-auto px-6 py-8 border-t border-gray-200">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-gray-600 text-sm">
            © {new Date().getFullYear()} PlagiarismShield. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
